    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <Box sx={{ flex: 1, mr: 1 }}>
                    <Typography variant="body1" sx={{ mb: 0.5, fontWeight: 'bold', color: theme.palette.text.primary }}>이름</Typography>
                    <TextField
                        margin="normal"
                ...
                <Box sx={{ flex: 1, ml: 1 }}>
                    <Typography variant="body1" sx={{ mb: 0.5, fontWeight: 'bold', color: theme.palette.text.primary }}>성</Typography>
                    <TextField
                        margin="normal"
                        placeholder="e.g. Doe"
                        variant="outlined"
            ...
            <Box sx={{ mb: 3 }}>
                <Typography variant="body1" sx={{ mb: 0.5, fontWeight: 'bold', color: theme.palette.text.primary }}>이메일</Typography>
                <TextField
                    fullWidth
                    margin="normal"

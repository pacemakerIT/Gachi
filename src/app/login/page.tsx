...
import { Box, Button, Divider, TextField, Typography, Link, Checkbox, FormControlLabel, useTheme } from '@mui/material';
    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                ...
                />
                <Link href="/lost-password" sx={{ textDecoration: 'none', color: theme.palette.primary.main }}>
                    비밀번호를 잊으셨나요?
                </Link>
            </Box>
            ...
            <Typography align="center" sx={{ mt: 2 }}>
                계정이 없으신가요? <Link href="/signup" sx={{ textDecoration: 'none', color: theme.palette.primary.main }}>회원가입</Link>
            </Typography>

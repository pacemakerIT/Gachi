  ...
  return (
    ...
    >
      ...
      >
        ...
        낯선 곳에서의 시작이 빛날 수 있도록 저희가 당신의 길잡이가 되어 함께
        하겠습니다.
      </Typography>
      ...
      <Grid
        ...
        alignItems="center"
      >
        <AboutItem numericalization="10+" element="Year Experience" />
        <AboutItem numericalization="300+" element="Members" />
        <AboutItem numericalization="50+" element="Mentors" />
      </Grid>
    </Box>
  );
}
